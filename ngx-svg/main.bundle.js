...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_path_path_component__ = __webpack_require__("../../../../../src/app/pages/path/path.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_text_text_component__ = __webpack_require__("../../../../../src/app/pages/text/text.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'path', component: __WEBPACK_IMPORTED_MODULE_15__pages_path_path_component__["a" /* PathComponent */] },
    { path: 'text', component: __WEBPACK_IMPORTED_MODULE_16__pages_text_text_component__["a" /* TextComponent */] },
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__pages_path_path_component__["a" /* PathComponent */],
                __WEBPACK_IMPORTED_MODULE_16__pages_text_text_component__["a" /* TextComponent */]
            ],
            imports: [
...
var PathComponent = /** @class */ (function () {
     ...
     */
    PathComponent.prototype.addNew = function () {
        this.paths.push({
            path: '',
            borderSize: 2,
            borderColor: '#000',
     ...
     * @returns Height of the container.
     */
    PathComponent.prototype.getHeight = function () {
        return Math.max.apply(Math, this.paths.map(function (el) {
            return el.y +
                Math.max.apply(Math, el.path.replace(/[^0-9 ]/g, '').replace(/\s\s+/g, ' ').split(' ').filter(function (element, index) { return index % 2 !== 0; }));
        })) + 20;
    };
    /**
     ...
     */
    PathComponent.prototype.removeRow = function (index) {
        this.paths.splice(index, 1);
    };
    PathComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            template: __webpack_require__("../../../../../src/app/pages/path/path.component.html")
        }),
        __metadata("design:paramtypes", [])
    ], PathComponent);
...
var TextComponent = /** @class */ (function () {
     ...
     */
    TextComponent.prototype.addNew = function () {
        this.texts.push({
            text: '',
            size: 10,
            color: '#000',
    ...
    TextComponent.prototype.getHeight = function () {
        return Math.max.apply(Math, this.texts.map(function (el) { return el.y; })) + 20;
    };
    /**
     * Removes specific text element.
     * @param index - Index of text element, which needs to be removed.
     */
    TextComponent.prototype.removeRow = function (index) {
        this.texts.splice(index, 1);
    };
    TextComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            template: __webpack_require__("../../../../../src/app/pages/text/text.component.html")
        }),
        __metadata("design:paramtypes", [])
    ], TextComponent);
